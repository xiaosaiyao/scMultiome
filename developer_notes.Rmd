...
usethis::use_package("methods", type = "Imports")              # for testing and changing object classes
...
usethis::use_package("HDF5Array", type = "Imports")            # for reading assays from hdf5 files
usethis::use_package("DelayedArray", type = "Imports")         # loaded assays inherit from this
...
usethis::use_package("dsdb.plus", type = "Suggests")           # class of TileMatrix experiment
