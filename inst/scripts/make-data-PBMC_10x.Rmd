...
se <- initiate.archr::import.archr.10x.se(file.path(outDir,"pbmc_granulocyte_sorted_10k_filtered_feature_bc_matrix.h5"), "PBMC_10k")
...
#### 10. Save the result
```{r}
scMultiome::saveMAE(MAE, "PBMC_10x.h5")
```
