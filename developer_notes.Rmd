...
usethis::use_package("ExperimentHub", type = "Depends")        # package is part of ExperimentHub
...
12. test that the accessor function for your dataset works
13. run `inst/scripts/upload-data.R`
