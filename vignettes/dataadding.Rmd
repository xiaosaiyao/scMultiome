...
This will work for most classes that inherit from `SingleCellExperiment`. All you have to do is add the package that defines the class as a dependency of `scMultiome`:
